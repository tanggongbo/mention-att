...
changes: load_checkpoint for finetuning models (initialization) with different architectures
...
from .checkpoint_utils import load_checkpoint as load_checkpoint_local
...
def main(args):
    ...
    extra_state, epoch_itr = load_checkpoint_local(
        args,
        trainer,
